...
*Note that not all attributes will force the underlying CART algorithm to generate a split.*
...
Clear all the contents from the file that opens and copy the entire code block included at the bottom of this post below into the blank document and save the file. Note the file exension should be .Rmd. Select Run Document:

<img src="/img/screen_shot3.png" height="300" width="600">

An R Markdown document with the embedded Shiny classification tree app should launch:
